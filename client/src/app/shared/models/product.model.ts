import { CreateProductParams } from '@app/products/data-access/products.service'
...
export const CreateMockProductParams: CreateProductParams = {
  ru: {
    title: 'Большой Семейный Дом',
    location: {
      position: 'Огайо-стрит, Южные ворота, Калифорния',
